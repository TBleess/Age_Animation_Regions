...
var params = parseQueryString();
    ...
    .addClass( "overflow" );;
      ...
      .click(function( event ) {
        event.preventDefault();
        location.href = "output/mp4/denver.avi";
		//animate();		
      });        
...
if(parseInt(params.stop,10)>0){setTimeout(function(){animate();}, 10); }
  ...
  //create a URL string with all variables not at a default value
    ...
    newurl = window.location.protocol + "//" + window.location.host + window.location.pathname + urlstr;
		...
		function changetitle(pvalue){
			...
			if(pvalue=="009"){return "Baca County";}
			if(pvalue=="011"){return "Bent County";}
